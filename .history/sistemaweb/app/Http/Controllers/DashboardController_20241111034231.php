...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $yAxisMax = ceil($maxSales * 1.1);

        $maxInventoryLevel = $inventoryLevels->max();
$yAxisInventoryMax = ceil($maxInventoryLevel * 1.1);  // Agrega un 10% de margen por encima del máximo


        return view('dashboard', compact('salesTotal', 'ordersToday', 'inventoryStatus', 'salesDatesLabels', 'salesTotals', 'inventoryItems', 'inventoryLevels', 'yAxisMax'));
    }
