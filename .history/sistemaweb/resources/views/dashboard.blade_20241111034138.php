...
@section('js')
    ...
    <script>
        ...
        var salesChart = new Chart(ctxSales, {
            type: 'line',
            data: {
                labels: @json($salesDatesLabels),  // Fechas formateadas en español desde el controlador
                datasets: [{
            ...
            options: {
                scales: {
                    x: {
                        type: 'category',  // Muestra cada día como una categoría en el eje X
                    },
                    y: {
                        beginAtZero: true,
                        max: @json($yAxisMax)  // Establece el límite superior
                    }
                }
            }
        });
