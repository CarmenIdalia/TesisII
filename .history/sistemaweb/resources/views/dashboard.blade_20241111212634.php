        ...
        <div class="card-body">
            ...
            {!! json_encode(
                [
                    ...
                    'inventario' => [
                        'productos' => $productLabels,
                        'niveles_stock' => $stockLevels,
                    ],
                ],
                JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE,
            ) !!}

            {{-- 'salesTotal', 'ordersToday', 'inventoryStatus', 'salesDatesLabels', 'salesTotals', 'inventoryItems', 'inventoryLevels', 'yAxisMax', 'yAxisInventoryMax --}}
        </pre>
        </div>
    </div>
