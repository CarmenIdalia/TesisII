    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var salesChart = new Chart(ctxSales, {
                type: 'line',
                data: {
                    labels: @json($salesDates),  // Fechas de ventas
                    datasets: [{
                        label: 'Ventas Diarias',
                        data: @json($salesData),  // Datos de ventas
                        borderWidth: 2,
                ...
                options: {
                    scales: {
                        x: {
                            type: 'category',  // Cambiar a 'category' si las fechas no están en formato de tiempo correcto
                            labels: @json($salesDates),  // Asegúrate de que las fechas estén correctamente formateadas
                        },
                        y: {
                            beginAtZero: true
                        }
