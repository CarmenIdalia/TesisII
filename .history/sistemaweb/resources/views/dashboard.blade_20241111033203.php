...
var salesChart = new Chart(ctxSales, {
    type: 'line',
    data: {
        labels: @json($salesDatesLabels),  // Fechas de los últimos X días
        datasets: [{
            label: 'Ventas Diarias',
            data: @json($salesTotals),  // Totales de ventas
            borderWidth: 2,
    ...
    options: {
        scales: {
            x: {
                type: 'time',  // Configura el eje X como escala de tiempo
                time: {
                    unit: 'day',
                    tooltipFormat: 'D MMM',  // Formato en el tooltip (ejemplo: "12 Nov")
                    displayFormats: {
                        day: 'D MMM'  // Formato en las etiquetas del eje X
                    }
                }
            },
            y: {
            ...
            var inventoryChart = new Chart(ctxInventory, {
                type: 'bar',
                data: {
                    labels: @json($inventoryItems), // Nombres de los artículos del inventario
                    datasets: [{
                        label: 'Nivel de Inventario',
                        data: @json($inventoryLevels), // Niveles de inventario
                        borderWidth: 1,
